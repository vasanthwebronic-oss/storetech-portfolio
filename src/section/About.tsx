  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-8">
        ...
        <p
          className={`text-lg text-gray-700 mb-4 transition-all duration-700 delay-100 ${
            sectionVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-6"
          }`}
        ...
        <p
          className={`text-lg text-gray-700 mb-6 transition-all duration-700 delay-150 ${
            sectionVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-6"
          }`}
        ...
        <div
          className={`bg-black text-white px-6 py-10 rounded-lg mb-10 transition-all duration-700 delay-200 ${
            sectionVisible
