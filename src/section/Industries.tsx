    ...
    <section id="industries" className="bg-black text-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Card 1 */}
          <div className="relative rounded-lg p-8 bg-[#0e1620] border border-[#0f451b] shadow-sm">
            ...
            <h3 className="mt-6 text-xl font-semibold text-white">Retail & Grocery</h3>
            <p className="mt-4 text-gray-300 leading-relaxed">
              Transform traditional stores into smart, automated spaces
            </p>
          </div>
          ...
          <div className="relative rounded-lg p-8 bg-[#0e1620] border border-[#0f451b] shadow-sm">
            ...
            <h3 className="mt-6 text-xl font-semibold text-white">Hospitality</h3>
            <p className="mt-4 text-gray-300 leading-relaxed">
              Provide seamless guest experiences with automated services
            </p>
          </div>
          ...
          <div className="relative rounded-lg p-8 bg-[#0e1620] border border-[#0f451b] shadow-sm">
            ...
            <h3 className="mt-6 text-xl font-semibold text-white">Corporate</h3>
            <p className="mt-4 text-gray-300 leading-relaxed">
              Smart micro-markets and office automation solutions
            </p>
          </div>
          ...
          <div className="relative rounded-lg p-8 bg-[#0e1620] border border-[#0f451b] shadow-sm">
            ...
            <h3 className="mt-6 text-xl font-semibold text-white">Residential</h3>
            <p className="mt-4 text-gray-300 leading-relaxed">
